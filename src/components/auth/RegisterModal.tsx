      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 m-4 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          {/* Option Client */}          <button
            onClick={onClient}
            className="bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl p-4 text-center hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-lg hover:scale-[1.02] active:scale-[0.99] transition-all duration-200"
          >
            <div className="mb-3 flex justify-center h-36 sm:h-40 relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-full w-full bg-contain bg-center bg-no-repeat"
                  style={{ backgroundImage: "url('/images/slides/team-meeting.svg')" }}>
                </div>
              </div>
              <div className="absolute bottom-0 right-0 h-10 w-10 bg-blue-100 dark:bg-blue-900/70 rounded-full flex items-center justify-center m-2 shadow-md">
          ...
          >
            <div className="mb-3 flex justify-center h-36 sm:h-40 relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-full w-full bg-contain bg-center bg-no-repeat"
                  style={{ backgroundImage: "url('/images/slides/business-meeting.svg')" }}>
                </div>
              </div>
              <div className="absolute bottom-0 right-0 h-10 w-10 bg-blue-100 dark:bg-blue-900/70 rounded-full flex items-center justify-center m-2 shadow-md">
