      ...
      <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col items-center justify-center h-full max-w-sm mx-auto">                <AvatarSelector
                  ...
                  onAvatarChange={async (file) => {
                    try {
                      ...
                      console.log('Upload réussi:', response.avatarUrl);
                      // Mise à jour de l'utilisateur avec le nouvel avatar
                      await updateUser({
                        ...user,
                  ...
                  onAvatarSelect={async (avatarUrl) => {
                    try {
                      ...
                      if (avatarUrl.startsWith('/avatars/')) {
                        ...
                        const file = new File([svgContent], avatarUrl.split('/').pop() || 'avatar.svg', { 
                          type: 'image/svg+xml'
                        });
            ...
            <div className="p-8 md:w-2/3 bg-white dark:bg-gray-800">              {/* Section des informations de base */}
