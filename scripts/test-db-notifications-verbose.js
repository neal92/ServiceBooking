...
async function testNotificationDatabase() {
  try {
    ...
    console.log('Structure table notifications:', tableStructure[0]);
    ...
    console.log('Requête JOIN:', joinQuery);
    ...
    if (joinResult[0].length > 0) {
      console.log('Première notification avec JOIN:', joinResult[0][0]);
    }
